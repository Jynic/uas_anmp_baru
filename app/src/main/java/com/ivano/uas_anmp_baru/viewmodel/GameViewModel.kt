...
class GameViewModel(application: Application): AndroidViewModel(application) {
    ...
    fun fetchGames(){
        ...
        val url = "http://192.168.0.186/uts_anmp/get_games.php" //IP DIGANTI SESUAI DENGAN IP JARINGAN YANG SEDANG DIGUNAKAN
    ...
    fun fetchGamesById(game_id: String){
        queue = Volley.newRequestQueue(getApplication())
        val url = "http://192.168.0.186/uts_anmp/get_games_by_id.php" //IP DIGANTI SESUAI DENGAN IP JARINGAN YANG SEDANG DIGUNAKAN
